...
tk.Button(root, text="Display Statistics", command=open_statistics_gui).grid(row=1, column=0, padx=10, pady=15)
tk.Button(root, text="Display Graphs", command=open_graphs_gui).grid(row=1, column=1, padx=10, pady=15)
tk.Button(root, text="Search Students", command=open_student_search_gui).grid(row=1, column=2, padx=10, pady=15)
